        ...
        for data_sample in data_samples:
            ...
            if not self.format_only:
                ...
                if (
                    pred_label.ndim == 2
                    and label.ndim == 2
                    and pred_label.shape[::-1] == label.shape
                ):
                    pred_label = pred_label.T.contiguous()
...
@METRICS.register_module()
class ShapeAlignedIoUMetric(IoUMetric):
    """IoU metric with a narrow guard for transposed prediction maps."""
